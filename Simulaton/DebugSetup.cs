...
namespace Simulaton
{
    class DebugSetup
    {
        ...
        private void AddPropertyUpdaters(Life human)
        {
            ...
            ModifyPropertyEvent decHealthMod = new ModifyPropertyEvent(energy, human.GetProperty(ID_PROPERTY_HEALTH), energyImportance, new SmallerThanThreshold(energyThreshold, -energyImpact));
            ...
            ModifyPropertyEvent dmgHealthMod = new ModifyPropertyEvent(hunger, human.GetProperty(ID_PROPERTY_HEALTH), hungerImportance, new SmallerThanThreshold(hungerThreshold, hungerImpact1));
            ModifyPropertyEvent dmgEnergyMod = new ModifyPropertyEvent(hunger, human.GetProperty(ID_PROPERTY_ENERGY), hungerImportance, new SmallerThanThreshold(hungerThreshold, hungerImpact1));
            ModifyPropertyEvent healthyMod = new ModifyPropertyEvent(hunger, human.GetProperty(ID_PROPERTY_HEALTH), hungerImportance, new LargerThanThreshold(1 - hungerThreshold, hungerImpact2));
            ...
            ModifyPropertyEvent drainEnergyMod = new ModifyPropertyEvent(social, human.GetProperty(ID_PROPERTY_ENERGY), socialImportance, new SmallerThanThreshold(socialThreshold, socialImpact));
            ModifyPropertyEvent energeticMod = new ModifyPropertyEvent(social, human.GetProperty(ID_PROPERTY_ENERGY), socialImportance, new LargerThanThreshold(socialThreshold, socialImpact));
